...
public interface IBioticStat {
	 ...
	 * server by {@link matteroverdrive.network.packet.server.PacketBioticActionKey}
	 *
	 * @param androidPlayer The Android Player.
	 * @param level         The unlocked stat level.
	 ...
	 * {@link net.minecraft.entity.ai.attributes.AttributeModifier}. Each
	 * {@link net.minecraft.entity.ai.attributes.AttributeModifier} is assigned to a
	 ...
	 *         {@link net.minecraft.entity.ai.attributes.AttributeModifier}.
