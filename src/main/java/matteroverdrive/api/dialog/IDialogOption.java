...
public interface IDialogOption {
	 ...
	 * {@link matteroverdrive.api.dialog.IDialogMessage#getOptions(IDialogNpc, EntityPlayer)}.
	 * Not to be confused with
	 * {@link matteroverdrive.api.dialog.IDialogMessage#onOptionsInteract(IDialogNpc, EntityPlayer, int)}
