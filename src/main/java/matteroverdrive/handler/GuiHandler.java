...
import matteroverdrive.container.ContainerTeleporter;
...
import matteroverdrive.gui.GuiTeleporter;
...
import matteroverdrive.tile.TileAreaTeleporter;
...
public class GuiHandler implements IGuiHandler {
	...
	public void register(Side side) {
		if (side == Side.SERVER) {
			...
			registerGuiAndContainer(TileAreaTeleporter.class, GuiTeleporter.class, ContainerTeleporter.class);
