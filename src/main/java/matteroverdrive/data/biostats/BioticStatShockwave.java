            ...
            if (!MinecraftForge.EVENT_BUS.post(new MOEventBionicStat(this, androidPlayer.getUnlockedLevel(this), androidPlayer))) {
                if (!entityPlayer.world.isRemote) {
                    ...
                    if (androidPlayer.hasEnoughEnergyScaled((int) (range * ENERGY))) {
                        ...
                        MatterOverdrive.NETWORK.sendToAllAround(new PacketSpawnParticle("shockwave", androidPlayer.getPlayer().posX, androidPlayer.getPlayer().posY + androidPlayer.getPlayer().getEyeHeight() / 2, androidPlayer.getPlayer().posZ, 1, RenderParticlesHandler.Blending.Additive, 10), androidPlayer.getPlayer(), 10);
                    } else {
